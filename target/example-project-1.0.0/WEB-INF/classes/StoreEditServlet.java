...
public class StoreEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("store-edit.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            response.sendRedirect("StoreMaintenanceServlet"); // 店舗一覧にリダイレクト（仮）
        } catch (SQLException e) {
            e.printStackTrace();
            request.setAttribute("errorMessage", "店舗の更新に失敗しました。");
            request.getRequestDispatcher("store-edit.jsp").forward(request, response);
        }
    }
